window.onload = function () {
    ...
    var fundo4 = document.getElementById('FUNDO4');
    var fundo5 = document.getElementById('FUNDO5');
    var fundo6 = document.getElementById('FUNDO6');
    var fundo7 = document.getElementById('FUNDO7');
    var fundo8 = document.getElementById('FUNDO8');
